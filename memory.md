...
| 2026-07-27 | [2026-07-27-forest-fire](./ledger/2026-07-27-forest-fire.md) | #040 · app | Threads thread (6 items, 4 imgs) SCHEDULED · IG skipped | **Threads SCHEDULED via Postiz MCP** (first cloud auto-publish since the 07-19 migration), postId `cms32p37g00izpn0yv8di2918` @ 2026-07-27T17:00:00Z on `@velacodexyz` `cmrs83llv00kdqj0yj2hp77yz`; 4 JPEGs on item 1, link in last. **ig-pending** (no velacodexyz IG in integrationList; carousel ready in ledger). Images hosted on branch `claude/optimistic-feynman-h8xef2`, re-hosted to uploads.postiz.com before scheduling. (#033-#039 have no rows; this run announces only the newest drop.) |
