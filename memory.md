...
| 2026-08-28 | [2026-08-28-acquaintance-immunization](./ledger/2026-08-28-acquaintance-immunization.md) | #070 · app | Threads card+thread (4 imgs) SCHEDULED via Postiz · IG ig-pending | **PUBLISHED (scheduled)**. First non-degraded cloud run: Postiz MCP connector attached, Threads post `cmtcsvt8o00wao40yzdfsq4xj` @ 2026-08-28T17:00:00Z verified QUEUE on @velacodexyz. IG skipped (no velacodexyz IG channel). Images hosted on branch `claude/optimistic-feynman-tjyy97`. (Gap: #033-#069 never forged into this repo; this run announces only the newest drop, #070.) |
