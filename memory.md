...
| 2026-08-29 | [2026-08-29-fix-two-errors](./ledger/2026-08-29-fix-two-errors.md) | #071 · research | Threads thread (4 imgs) scheduled QUEUE · IG ig-pending | **posted** (Threads), Postiz MCP connector present + verified (@velacodexyz `cmrs83llv00kdqj0yj2hp77yz`); thread id `cmte86dka00igpb0y5e52e4ig` @ 2026-08-29T17:00:00Z, state QUEUE. IG skipped `ig-pending` (no velacodexyz IG channel). Images hosted on branch `claude/optimistic-feynman-hzzg5k` via commit SHA raw ref. (Backlog #033-#070 not forged here; this run announces the newest drop #071 only) |
