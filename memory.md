...
| 2026-08-03 | [2026-08-03-k-core](./ledger/2026-08-03-k-core.md) | #047 · research | Threads thread (4 imgs) scheduled · IG ig-pending | **scheduled** via Postiz MCP (first cloud auto-publish since the 07-19 Buffer→Postiz migration). Connector verified (`@velacodexyz` Threads `cmrs83llv00kdqj0yj2hp77yz`); thread post `cmsd2taxv00nimh0ygkl8bm0r` @ 2026-08-03T17:00:00Z; 4 JPEGs pre-uploaded to uploads.postiz.com. IG skipped (no velacodexyz IG channel; only PetverseApp present). Images hosted SHA-pinned on branch `claude/optimistic-feynman-2c8w8p` (not main). Note: drops #033-#046 have no rows (unforged); this run announces the newest, #047. |
