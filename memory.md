...
| 2026-07-23 | [2026-07-23-life-like-automata](./ledger/2026-07-23-life-like-automata.md) | #036 · app | Threads card+thread (4 imgs) SCHEDULED via Postiz · IG skipped | scheduled (Threads) via Postiz MCP, postId `cmrxd5qqt00e5m90y2h3s6vsx` @ 2026-07-23T17:00:00Z; ig-pending (no velacodexyz IG in Postiz). First clean cloud Postiz publish. Images hosted on BRANCH claude/optimistic-feynman-xp39p3 (not main), uploaded to uploads.postiz.com. (#033 prime-gaps, #034 fifteen-puzzle, #035 prime-race not forged, no rows; forge separately if wanted) |
