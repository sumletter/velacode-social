...
| 2026-08-05 | [2026-08-05-complex-contagion](./ledger/2026-08-05-complex-contagion.md) | #049 · research | Threads card+thread (4 imgs, 6 items) · IG staged | **published** (Threads scheduled via Postiz, post `cmsfxvag0005cow0y0uwfxfjw` @ 2026-08-05T17:00:00Z, first-attempt, connector verified) · **ig-pending** (no @velacodexyz IG channel). Images hosted + verified; 4 JPEGs uploaded to uploads.postiz.com. (Index jumps #032->#049: drops #033-#048 not forged into this repo; this run announces the newest drop #049 only.) |
