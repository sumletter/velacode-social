...
| 2026-08-20 | [2026-08-20-coin-turning](./ledger/2026-08-20-coin-turning.md) | #064 · game | Threads thread (6 items, 4 imgs) SCHEDULED via Postiz MCP · IG carousel (5) staged | scheduled, Threads `cmt1d836w007epc0y89zpsqnl` @ 2026-08-20T17:00Z read back QUEUE on @velacodexyz; ig-pending (velacodexyz IG not connected). Note: routine had no rows #033-#063; this run announces #064 only. Slides hosted on branch `claude/optimistic-feynman-a1vv7s`, not main. |
