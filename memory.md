...
| 2026-07-20 | [2026-07-20-prime-gaps](./ledger/2026-07-20-prime-gaps.md) | #033 · research | Threads card+thread (4 imgs) SCHEDULED · IG carousel (5) ig-pending | **Threads SCHEDULED via Postiz MCP** (first fully-automated cloud publish post-migration), post `cmrt2llsu001fmr0yg77ghj2a` @ 2026-07-20T17:00:00Z; 4 JPEGs uploaded via uploadFromUrlTool + attached to item 1, link in last item. IG `ig-pending` (velacodexyz IG not connected in Postiz; ready payload in ledger). Images hosted on branch `claude/optimistic-feynman-t1h0q5`. (#025 grundy-values still skipped, no row) |
