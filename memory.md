...
| 2026-08-15 | [2026-08-15-four-peg-hanoi](./ledger/2026-08-15-four-peg-hanoi.md) | #059 · game | Threads thread (4 imgs) SCHEDULED via Postiz `cmsu83k3k007yql0yl5ddswm3` @ 2026-08-15T17:00Z (QUEUE) · IG ig-pending | **posted (Threads) · ig-pending.** First clean cloud auto-publish via Postiz MCP: connector verified, 4 JPEGs uploaded, thread scheduled + confirmed QUEUE. IG skipped (no velacodexyz IG channel). Images hosted by commit SHA 31b19fd on branch claude/optimistic-feynman-xu5dej (not main). **Gap: #033–#058 have no rows and were not backfilled; #025 grundy-values still skipped too.** |
