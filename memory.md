...
| 2026-08-22 | [2026-08-22-permutation-parity](./ledger/2026-08-22-permutation-parity.md) | #066 · research | Threads card+thread (4 imgs) · IG skipped | **PUBLISHED** to Threads via Postiz MCP (post `cmt482bk101sjjj0yxe6nxb0g` @ 2026-08-22T17:00:00Z = 18:00 BST). First real cloud auto-publish. IG `ig-pending` (velacodexyz IG not connected in Postiz). Images hosted on branch `claude/optimistic-feynman-ndcajm`. (drops #033-#065 not forged by this run; it announces the newest drop only, per the routine mandate) |
