...
| 2026-07-28 | [2026-07-28-abelian-sandpile](./ledger/2026-07-28-abelian-sandpile.md) | #041 · research | Threads thread (6 items, 4 imgs) · IG skipped | **scheduled** via Postiz MCP (Threads `cmrs83llv00kdqj0yj2hp77yz`, postId `cms4i0jbv00hvpn0yxfk13voo` @ 2026-07-28T17:00:00Z). `ig-pending` (no velacodexyz IG channel). Note: drops #033-#040 (and #025) were never forged, this run announces #041 only, no backlog fired. |
