...
| 2026-08-04 | [2026-08-04-bootstrap-percolation](./ledger/2026-08-04-bootstrap-percolation.md) | #048 · app | Threads thread (6 items, 4 imgs) SCHEDULED via Postiz `cmseicr1l00dno60ynfo5jmh9` @ 2026-08-04T17:00:00Z · IG ig-pending | posted (Threads scheduled), IG skipped (velacodexyz IG not connected). Gap: #033-#047 never forged (no rows/ledgers); this run announces only the newest drop #048. |
