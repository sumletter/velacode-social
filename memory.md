...
| 2026-08-07 | [2026-08-07-vulnerable-giant](./ledger/2026-08-07-vulnerable-giant.md) | #051 · research | Threads thread (4 imgs) · IG ig-pending | **PUBLISHED to Threads** via Postiz MCP (postId `cmsissdrw01bsl30yktyu9jml`, @velacodexyz `cmrs83llv00kdqj0yj2hp77yz`, scheduled 2026-08-07T17:00:00Z); 4 JPEGs pre-uploaded to uploads.postiz.com. IG skipped, no velacodexyz IG channel connected. Post-publish `cdninstagram.com` check owed after 17:00Z. (Gap: prior row is #032; #033-#050 never forged, absent from memory; back-fill separately if wanted.) |
