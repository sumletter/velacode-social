...
| 2026-07-26 | [2026-07-26-percolation](./ledger/2026-07-26-percolation.md) | #039 · research | Threads thread (5+link, 4 imgs) SCHEDULED via Postiz · IG staged | **published to Threads** via Postiz MCP (postId `cms1n5tlk006rny0yr4iwjyfj`, @velacodexyz, scheduled 2026-07-26T17:00:00Z); IG = **ig-pending** (no velacodexyz IG in Postiz). First cloud-routine auto-publish since the 07-19 Postiz migration. (#033-#038 + #025 still unforged; forge separately if wanted) |
